...
private void applyFilter() {
    ...
    sorter.setRowFilter(null); // reset filter dulu
    sorter.setSortKeys(null);  // reset sort dulu
    ...
    switch (pilihan) {
        ...
        case "Terlama":
            ...
            break;
        case "Selesai":
            sorter.setRowFilter(RowFilter.regexFilter("(?i)Selesai", 4));
            break;
        case "Belum Diproses":
            sorter.setRowFilter(RowFilter.regexFilter("(?i)Belum", 4));
            break;
        case "Semua":
        default:
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 68, -1));
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, -1, -1));
        ...
        add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 60, -1, -1));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(
            new String[] { "Semua", "Terbaru", "Terlama", "Selesai", "Belum Diproses" }
        ));
